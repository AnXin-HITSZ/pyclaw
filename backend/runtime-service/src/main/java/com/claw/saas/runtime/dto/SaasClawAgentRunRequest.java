...
public record SaasClawAgentRunRequest(
        String prompt,
        String provider,
    ...
    public SaasClawAgentRunRequest {
    ...
    public SaasClawAgentRunRequest(String prompt, String provider, String sessionId, String toolProfile,
