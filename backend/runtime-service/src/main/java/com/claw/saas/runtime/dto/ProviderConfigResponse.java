...
public record ProviderConfigResponse(
    ...
    public static ProviderConfigResponse from(com.claw.saas.runtime.entity.ProviderConfigEntity entity) {
    ...
    public static ProviderConfigResponse from(com.claw.saas.runtime.entity.ProviderConfigEntity entity,
                                               com.claw.saas.runtime.config.SecretEncryptionService encryption) {
