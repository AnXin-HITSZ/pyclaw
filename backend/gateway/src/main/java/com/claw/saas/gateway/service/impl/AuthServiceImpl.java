...
import com.claw.saas.gateway.config.JwtService;
...
import com.claw.saas.gateway.service.AuthService;
import com.claw.saas.gateway.service.SandboxOrchestratorService;
...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthServiceImpl(UserRepository users, PasswordEncoder passwordEncoder, JwtService jwtService, SandboxOrchestratorService sandboxOrchestrator) {
        this.users = users;
