package com.claw.saas.claw.config;
 ...
 * <p>
 * The encryption key is derived from the {@code claw.encryption.secret} property.
...
public class SecretEncryptionService {
    ...
    public SecretEncryptionService(@Value("${claw.encryption.secret:}") String encryptionSecret) {
        if (encryptionSecret == null || encryptionSecret.isBlank()) {
            this.keyBytes = null;
        } else {
            this.keyBytes = deriveKey(encryptionSecret);
        }
    }
